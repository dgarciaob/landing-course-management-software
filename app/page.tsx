...
import NextSection from "@/components/landing/next-section";
...
//         <Link
//           href="/"
//           className="flex items-center justify-center bg-indigo-100 rounded-full h-10 w-10"
//         >
//           <Rocket size={20} color="#050250" />
//         </Link>
...
//         >
//           <button className="m-9 animate-buttonheartbeat rounded-md bg-indigo-500 px-6 py-3 text-sm font-semibold text-white">
...
//         ¿Estas listo para llevar tu inmobiliaria al siguiente nivel?
//       </h1>
